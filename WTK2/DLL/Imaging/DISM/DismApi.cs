...
namespace Microsoft.Dism
{
    ...
    public static partial class DismApi
    {
        ...
        ///     session with an image by using the <see cref="OpenOfflineSession(string)" /> method.
        /// </param>
        /// <param name="driverPath">A relative or absolute path to the driver .inf file.</param>
        /// <param name="forceUnsigned">
        ///     Indicates whether to accept unsigned drivers to an x64-based image. Unsigned drivers will
        ///     automatically be added to an x86-based image.
        /// </param>
        ...
        public static void ExportImage(string source, uint index, string destination, uint exportflags, DismApi.DismCompressType compression, Dism.DismProgressCallback progress, object userData)
        {
            var hr = NativeMethods.DismExportImage(source, index, destination, exportflags, compression, progress, userData);
        ...
        /// <param name="session">
        ///     A valid DISM Session. The DISM Session must be associated with an image. You can associate a
        ///     session with an image by using the OpenSession method.
        /// </param>
        ...
        ///     Specifies whether to ignore the internal applicability checks that are done when a package is
        ///     added.
        /// </param>
        ...
        public static void AddPackage(DismSession session, string packagePath, bool ignoreCheck, bool preventPending,
            Dism.DismProgressCallback progressCallback)
        {
        ...
        /// <exception cref="OperationCanceledException">When the user requested the operation be canceled.</exception>
        public static void AddPackage(DismSession session, string packagePath, bool ignoreCheck, bool preventPending,
            Dism.DismProgressCallback progressCallback, object userData)
        {
            // Create a DismProgress object to wrap the callback and allow cancellation
            var progress = new DismProgress(progressCallback, userData);

            // Call the native function
            var hr = NativeMethods.DismAddPackage(session, packagePath, ignoreCheck, preventPending,
                progress.EventHandle, progress.DismProgressCallbackNative, IntPtr.Zero);
        ...
        ///     Specifies whether the packages that are listed in an answer file will be processed in a
        ///     single session or in multiple sessions.
        /// </param>
            ...
            Dism.DismProgressCallback progressCallback, object userData)
        {
            ...
            // Call the native function
            var hr = NativeMethods.DismCheckImageHealth(session, scanImage, progress.EventHandle,
                progress.DismProgressCallbackNative, IntPtr.Zero, out imageHealthState);
        ...
        /// <summary>
        ///     Closes a DISMSession created by <see cref="OpenOfflineSession(string)" /> method. This function does not unmount
        ///     the image. To unmount the image, use the <see cref="UnmountImage(string, bool)" /> method once all sessions are
        ///     closed.
        /// </summary>
        /// <param name="session">
        ///     A valid DISM Session. The DISM Session must be associated with an image. You can associate a
        ///     session with an image by using the <see cref="OpenOfflineSession(string)" /> or <see cref="OpenOnlineSession" />
        ///     method.
        /// </param>
        /// <exception cref="DismException">When a failure occurs.</exception>
        ...
        {
            // Create the flags
            var flags = discardChanges ? DISM_DISCARD_IMAGE : DISM_COMMIT_MASK;

            // Create a DismProgress object to wrap the callback and allow cancellation
            var progress = new DismProgress(progressCallback, userData);

            // Call the native function
            var hr = NativeMethods.DismCommitImage(session, flags, progress.EventHandle,
                progress.DismProgressCallbackNative, IntPtr.Zero);
        ...
        public static void DisableFeature(DismSession session, string featureName, string packageName,
            bool removePayload)
        {
        ...
        /// <exception cref="DismRebootRequiredException">When the operation requires a reboot to complete.</exception>
        public static void DisableFeature(DismSession session, string featureName, string packageName,
            bool removePayload, Dism.DismProgressCallback progressCallback)
        {
        ...
        /// <exception cref="DismRebootRequiredException">When the operation requires a reboot to complete.</exception>
        public static void DisableFeature(DismSession session, string featureName, string packageName,
            bool removePayload, Dism.DismProgressCallback progressCallback, object userData)
        {
            // Create a DismProgress object to wrap the callback and allow cancellation
            var progress = new DismProgress(progressCallback, userData);

            // Call the native function
            var hr = NativeMethods.DismDisableFeature(session, featureName, packageName, removePayload,
                progress.EventHandle, progress.DismProgressCallbackNative, IntPtr.Zero);
        ...
        ///     downloading files if none are found in other specified locations. Before checking WU, DISM will check for the files
        ///     in the SourcePaths provided and in any locations specified in the registry by group policy. If the files required
        ///     to enable the feature are still present on the computer, this flag is ignored.
        /// </param>
        /// <param name="enableAll">
        ///     Specifies whether to enable all dependencies of the feature. If the specified feature or any
        ///     one of its dependencies cannot be enabled, none of them will be changed from their existing state.
        /// </param>
        /// <exception cref="DismException">When a failure occurs.</exception>
        /// <exception cref="DismRebootRequiredException">When the operation requires a reboot to complete.</exception>
        public static void EnableFeatureByPackageName(DismSession session, string featureName, string packageName,
            bool limitAccess, bool enableAll)
        {
        ...
        /// <exception cref="DismRebootRequiredException">When the operation requires a reboot to complete.</exception>
        public static void EnableFeatureByPackageName(DismSession session, string featureName, string packageName,
            bool limitAccess, bool enableAll, List<string> sourcePaths)
        {
        ...
        /// <exception cref="DismRebootRequiredException">When the operation requires a reboot to complete.</exception>
        public static void EnableFeatureByPackageName(DismSession session, string featureName, string packageName,
            bool limitAccess, bool enableAll, List<string> sourcePaths, Dism.DismProgressCallback progressCallback)
        {
            EnableFeatureByPackageName(session, featureName, packageName, limitAccess, enableAll, sourcePaths,
        ...
        public static void EnableFeatureByPackageName(DismSession session, string featureName, string packageName,
            ...
            object userData)
        {
            EnableFeature(session, featureName, packageName, DismPackageIdentifier.Name, limitAccess, enableAll,
                sourcePaths, progressCallback, userData);
        }
        ...
        /// <exception cref="DismException">When a failure occurs.</exception>
        /// <exception cref="DismRebootRequiredException">When the operation requires a reboot to complete.</exception>
        public static void EnableFeatureByPackagePath(DismSession session, string featureName, string packagePath,
            bool limitAccess, bool enableAll)
        {
        ...
        public static void EnableFeatureByPackagePath(DismSession session, string featureName, string packagePath,
            bool limitAccess, bool enableAll, List<string> sourcePaths, Dism.DismProgressCallback progressCallback)
        {
            EnableFeatureByPackagePath(session, featureName, packagePath, limitAccess, enableAll, sourcePaths,
                progressCallback, null);
        }
        ...
        public static void EnableFeatureByPackagePath(DismSession session, string featureName, string packagePath,
            ...
            object userData)
        {
            EnableFeature(session, featureName, packagePath, DismPackageIdentifier.Path, limitAccess, enableAll,
                sourcePaths, progressCallback, userData);
        }
        ...
        public static DismDriverCollection GetDriverInfo(DismSession session, string driverPath)
        {
            ...
            uint driverInfoCount;
            IntPtr driverPackagePtr;

            // Call the native function
            var hr = NativeMethods.DismGetDriverInfo(session, driverPath, out driverInfoPtr, out driverInfoCount,
                out driverPackagePtr);
        ...
        /// <returns>
        ///     A <see cref="DismDriverPackageCollection" /> object containing a collection of
        ///     <see cref="DismDriverPackage" /> objects.
        /// </returns>
        /// <exception cref="DismException">When a failure occurs.</exception>
        public static DismDriverPackageCollection GetDrivers(DismSession session, bool allDrivers)
        {
            ...
            try
            {
                ...
                // Add the items
                driverPackages.AddRange<DismApi.DismDriverPackage_>(driverPackagePtr, (int) driverPackageCount,
                    i => new DismDriverPackage(i));
            }
            finally
            {
                // Clean up
        ...
        {
            return GetFeatureInfo(session, featureName, "", DismPackageIdentifier.None);
        }
        ...
        /// <returns>A <see cref="DismFeatureInfo" /> object.</returns>
        /// <exception cref="DismException">When a failure occurs.</exception>
        public static DismFeatureInfo GetFeatureInfoByPackageName(DismSession session, string featureName,
            string packageName)
        {
        ...
        /// <returns>A <see cref="DismFeatureInfo" /> object.</returns>
        /// <exception cref="DismException">When a failure occurs.</exception>
        public static DismFeatureInfo GetFeatureInfoByPackagePath(DismSession session, string featureName,
            string packagePath)
        {
        ...
        /// <param name="session">
        ///     A valid DISM Session. The DISM Session must be associated with an image. You can associate a
        ///     session with an image by using the OpenSession Function.
        /// </param>
        ...
        /// <exception cref="DismException">When a failure occurs.</exception>
        public static DismFeatureCollection GetFeatureParentByName(DismSession session, string featureName,
            string packageName)
        {
        ...
        /// <returns>A <see cref="DismFeatureCollection" /> object containing a collection of <see cref="DismFeature" /> objects.</returns>
        /// <exception cref="DismException">When a failure occurs.</exception>
        public static DismFeatureCollection GetFeatureParentByPath(DismSession session, string featureName,
            string packagePath)
        {
        ...
        /// <returns>
        ///     A <see cref="DismImageInfoCollection" /> object containing a collection of <see cref="DismImageInfo" />
        ///     objects.
        /// </returns>
        /// <exception cref="DismException">When a failure occurs.</exception>
        public static DismImageInfoCollection GetImageInfo(string imageFilePath)
        {
            ...
            try
            {
                ...
                // Add the items
                imageInfos.AddRange<DismApi.DismImageInfo_>(imageInfoPtr, (int) imageInfoCount,
                    i => new DismImageInfo(i));
            }
            finally
            {
                // Clean up
        ...
        public static string GetLastErrorMessage()
        {
            ...
            try
            {
                ...
                if (NativeMethods.DismGetLastErrorMessage(out errorMessagePtr) == 0)
                {
                    ...
                    if (String.IsNullOrWhiteSpace(dismString) == false)
                    {
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="DismMountedImageInfoCollection" /> object containing a collection of
        ///     <see cref="DismMountedImageInfo" /> objects.
        /// </returns>
        /// <exception cref="DismException">When a failure occurs.</exception>
        public static DismMountedImageInfoCollection GetMountedImages()
        {
            ...
            try
            {
                ...
                // Add the items
                mountedImageInfos.AddRange<DismApi.DismMountedImageInfo_>(mountedImageInfoPtr,
                    (int) mountedImageInfoCount, i => new DismMountedImageInfo(i));
            }
            finally
            {
                // Clean up
        ...
        /// <param name="session">
        ///     A valid DISM Session. The DISM Session must be associated with an image. You can associate a
        ///     session with an image by using the OpenImageSession Function.
        /// </param>
        ...
        /// <summary>
        ///     Gets a collection of each package in an image and provides basic information about each package, such as the
        ///     package name and type of package.
        /// </summary>
        ...
        ///     A relative or absolute path to a log file. All messages generated will be logged to this
        ///     path. If NULL, the default log path, %windir%\Logs\DISM\dism.log, will be used.
        /// </param>
        /// <exception cref="DismException">When a failure occurs.</exception>
        ...
        ///     A relative or absolute path to a scratch directory. DISM API will use this directory for
        ///     internal operations. If null, the default temp directory, \Windows\%Temp%, will be used.
        /// </param>
        /// <exception cref="DismException">When a failure occurs.</exception>
        ...
        /// <exception cref="OperationCanceledException">When the user requested the operation be canceled.</exception>
        public static void MountImage(string imageFilePath, string mountPath, int imageIndex, bool readOnly,
            DismMountImageOptions options, Dism.DismProgressCallback progressCallback)
        {
        ...
        /// <exception cref="OperationCanceledException">When the user requested the operation be canceled.</exception>
        public static void MountImage(string imageFilePath, string mountPath, int imageIndex, bool readOnly,
            DismMountImageOptions options, Dism.DismProgressCallback progressCallback, object userData)
        {
            MountImage(imageFilePath, mountPath, imageIndex, null, DismImageIdentifier.ImageIndex, readOnly, options,
        ...
        public static void MountImage(string imageFilePath, string mountPath, string imageName, bool readOnly,
            DismMountImageOptions options, Dism.DismProgressCallback progressCallback, object userData)
        {
            MountImage(imageFilePath, mountPath, 0, imageName, DismImageIdentifier.ImageName, readOnly, options,
                progressCallback, userData);
        }
        ...
        ///     An absolute or relative path to the root directory of an offline Windows image or an absolute
        ///     or relative path to the root directory of a mounted Windows image.
        /// </param>
        ...
        ///     A relative or absolute path to the Windows directory. The path is relative to the mount
        ///     point.
        /// </param>
        /// <param name="systemDrive">
        ///     The letter of the system drive that contains the boot manager. If SystemDrive is NULL, the
        ///     default value of the drive containing the mount point is used.
        /// </param>
        /// <returns>A <see cref="DismSession" /> object.</returns>
        /// <exception cref="DismException">When a failure occurs.</exception>
        ...
        ///     You can use the GetDrivers method to get the published name of the driver.
        /// </param>
        /// <exception cref="DismException">When a failure occurs.</exception>
        ...
        /// </param>
        /// <param name="limitAccess">
        ///     Specifies whether the RestoreImageHealth method should contact Windows Update (WU) as a
        ///     source location for downloading repair files. Before checking WU, DISM will check for the files in the sourcePaths
        ///     provided and in any locations specified in the registry by Group Policy. If the files that are required to enable
        ///     the feature are found in these other specified locations, this flag is ignored.
        /// </param>
        /// <exception cref="DismException">When a failure occurs.</exception>
            ...
            Dism.DismProgressCallback progressCallback, object userData)
        {
            ...
            // Call the native function
            var hr = NativeMethods.DismRestoreImageHealth(session, sourcePathsArray, (uint) sourcePathsArray.Length,
                limitAccess, progress.EventHandle, progress.DismProgressCallbackNative, IntPtr.Zero);
        ...
        /// <summary>
        ///     Shuts down DISM API. Shutdown must be called once per process. Other DISM API function calls will fail after
        ...
        {
            // Determine flags
            var flags = commitChanges ? DISM_COMMIT_MASK : DISM_DISCARD_IMAGE;

            // Create a DismProgress object to wrap the callback and allow cancellation
            var progress = new DismProgress(progressCallback, userData);

            // Call the native function
            var hr = NativeMethods.DismUnmountImage(mountPath, flags, progress.EventHandle,
                progress.DismProgressCallbackNative, IntPtr.Zero);
        ...
        /// </summary>
        /// <param name="handle">
        ///     A pointer to the structure, or array of structures, to be deleted. The structure must have been
        ///     returned by an earlier call to a DISM API function.
        /// </param>
        ...
        /// <exception cref="OperationCanceledException">When the user requested the operation be canceled.</exception>
        /// <exception cref="DismRebootRequiredException">When the operation requires a reboot to complete.</exception>
        private static void EnableFeature(DismSession session, string featureName, string identifier,
            DismPackageIdentifier packageIdentifier, bool limitAccess, bool enableAll, List<string> sourcePaths,
            Dism.DismProgressCallback progressCallback, object userData)
        {
            // Get the list of source paths as an array
            var sourcePathsArray = sourcePaths == null ? new string[0] : sourcePaths.ToArray();
            ...
            // Call the native function
            var hr = NativeMethods.DismEnableFeature(session, featureName, identifier,
                identifier == null ? DismPackageIdentifier.None : packageIdentifier, limitAccess, sourcePathsArray,
                (uint) sourcePathsArray.Length, enableAll, progress.EventHandle, progress.DismProgressCallbackNative,
                IntPtr.Zero);
        ...
        /// <returns>A <see cref="DismFeatureInfo" /> object.</returns>
        /// <exception cref="DismException">When a failure occurs.</exception>
        private static DismFeatureInfo GetFeatureInfo(DismSession session, string featureName, string identifier,
            DismPackageIdentifier packageIdentifier)
        {
            ...
            // Call the native function
            var hr = NativeMethods.DismGetFeatureInfo(session, featureName, identifier, packageIdentifier,
                out featureInfoPtr);
        ...
        /// <returns>A <see cref="DismFeatureCollection" /> object containing a collection of <see cref="DismFeature" /> objects.</returns>
        /// <exception cref="DismException">When a failure occurs.</exception>
        private static DismFeatureCollection GetFeatureParent(DismSession session, string featureName, string identifier,
            DismPackageIdentifier packageIdentifier)
        {
            ...
            // Call the native function
            var hr = NativeMethods.DismGetFeatureParent(session, featureName, identifier, packageIdentifier,
                out featurePtr, out featureCount);
        ...
        /// <returns>A <see cref="DismFeatureCollection" /> object containing a collection of <see cref="DismFeature" /> objects.</returns>
        /// <exception cref="DismException">When a failure occurs.</exception>
        private static DismFeatureCollection GetFeatures(DismSession session, string identifier,
            DismPackageIdentifier packageIdentifier)
        {
            var features = new DismFeatureCollection();
            ...
            // Call the native function
            var hr = NativeMethods.DismGetFeatures(session, identifier, packageIdentifier, out featurePtr,
                out featureCount);
        ...
        /// <returns>A <see cref="DismPackageInfo" /> object.</returns>
        /// <exception cref="DismException">When a failure occurs.</exception>
        private static DismPackageInfo GetPackageInfo(DismSession session, string identifier,
            DismPackageIdentifier packageIdentifier)
        {
            // Used for the native call
        ...
        /// <exception cref="DismException">When a failure occurs.</exception>
        /// <exception cref="OperationCanceledException">When the user requested the operation be canceled.</exception>
        private static void MountImage(string imageFilePath, string mountPath, int imageIndex, string imageName,
            DismImageIdentifier imageIdentifier, bool readOnly, DismMountImageOptions options,
            Dism.DismProgressCallback progressCallback, object userData)
        {
            // Determine the flags to pass to the native call
            var flags = (readOnly ? DISM_MOUNT_READONLY : DISM_MOUNT_READWRITE) | (uint) options;

            // Create a DismProgress object to wrap the callback and allow cancellation
            var progress = new DismProgress(progressCallback, userData);

            // Call the native function
            var hr = NativeMethods.DismMountImage(imageFilePath, mountPath, (uint) imageIndex, imageName,
                imageIdentifier, flags, progress.EventHandle, progress.DismProgressCallbackNative, IntPtr.Zero);
        ...
        /// </summary>
        /// <param name="imagePath">
        ///     An absolute or relative path to the root directory of an offline Windows image, an absolute or
        ///     relative path to the root directory of a mounted Windows image, or DISM_ONLINE_IMAGE to associate with the online
        ...
        private static DismSession OpenSession(string imagePath, string windowsDirectory, string systemDrive)
        {
            ...
            // Call the native function
            var ret = NativeMethods.DismOpenSession(imagePath, windowsDirectory, systemDrive, out session);
        ...
        /// <exception cref="DismException">When a failure occurs.</exception>
        /// <exception cref="OperationCanceledException">When the user requested the operation be canceled.</exception>
        private static void RemovePackage(DismSession session, string identifier,
            DismPackageIdentifier packageIdentifier, Dism.DismProgressCallback progressCallback, object userData)
        {
            // Create a DismProgress object to wrap the callback and allow cancellation
            var progress = new DismProgress(progressCallback, userData);

            // Call the native function
            var hr = NativeMethods.DismRemovePackage(session, identifier, packageIdentifier, progress.EventHandle,
                progress.DismProgressCallbackNative, IntPtr.Zero);
