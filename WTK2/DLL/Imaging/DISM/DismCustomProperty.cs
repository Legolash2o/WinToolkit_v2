...
namespace Microsoft.Dism
{
    ...
    {
        /// <summary>
        ///     Describes the custom properties of a package. Custom properties are any properties that are not found in
        ///     DismPackage Structure or DismFeature Structure.
        /// </summary>
        /// <remarks>
    ...
    /// <summary>
    ///     Represents the custom properties of a package. Custom properties are any properties that are not found in
    ///     <see cref="DismPackage" /> or <see cref="DismFeature" />.
    /// </summary>
    public class DismCustomProperty
    {
        ...
        ///     A native <see cref="DismApi.DismCustomProperty_" /> struct that holds the data of the
        ///     custom property
        /// </param>
        ...
        /// <summary>
        ///     Determines whether the specified <see cref="DismCustomProperty" /> is equal to the current
        ///     <see cref="DismCustomProperty" />.
        /// </summary>
        /// <param name="customProperty">A <see cref="DismCustomProperty" /> object to compare with the current object.</param>
        /// <returns>
        ///     <code>true</code> if the specified <see cref="DismCustomProperty" /> is equal to the current
        ///     <see cref="DismCustomProperty" />; otherwise, false.
        /// </returns>
        ...
        public override int GetHashCode()
        {
            return (string.IsNullOrWhiteSpace(Name) ? 0 : Name.GetHashCode())
                   ^ (string.IsNullOrWhiteSpace(Path) ? 0 : Path.GetHashCode())
                   ^ (string.IsNullOrWhiteSpace(Value) ? 0 : Value.GetHashCode());
        }
    }
