...
namespace Microsoft.Dism
{
    ...
    {
        /// <summary>
        ///     Describes the architecture and hardware that the driver supports. The DismGetDriverInfo Function returns an object
        ///     that includes an array of DismDriver structures. If you specify a DriverPath using the published name of the driver
        ///     installed in the image, for example OEM1.inf, the array includes only the applicable hardware and architectures
        ///     that are installed in the image. You can also specify a DriverPath using the source location of an .inf file on the
        ///     technician computer. If you use the source location, the array includes all of the supported architectures and
        ///     hardware that exist in the .inf file before it is installed to an architecture-specific image.
        /// </summary>
        /// <remarks>
    ...
    public sealed class DismDriver
    {
        ...
        {
            get { return (DismProcessorArchitecture) _driver.Architecture; }
        }
        ...
        public string CompatibleIds
        {
            get { return _driver.CompatibleIds; }
        }
        ...
        public string HardwareDescription
        {
            get { return _driver.HardwareDescription; }
        }
        ...
        public string ManufacturerName
        {
            get { return _driver.ManufacturerName; }
        }
        ...
        /// <returns>
        ///     true if the specified <see cref="DismDriver" /> is equal to the current <see cref="DismDriver" />; otherwise,
        ///     false.
        /// </returns>
