...
namespace Microsoft.Dism
{
    public static partial class DismApi
    {
        ...
        internal struct DismDriverPackage_
        {
            ...
            /// <summary>
            ///     TRUE if the driver is included on the Windows distribution media and automatically installed as part of Windows®,
            ///     otherwise FALSE.
            /// </summary>
            public bool InBox;
    ...
    public sealed class DismDriverPackage
    {
        ...
        internal DismDriverPackage(DismApi.DismDriverPackage_ driverPackage)
        {
            ...
            Version = new Version((int) driverPackage.MajorVersion, (int) driverPackage.MinorVersion,
                (int) driverPackage.Build, (int) driverPackage.Revision);
        }
        ...
        public bool BootCritical
        {
            get { return _driverPackage.BootCritical; }
        }
        ...
        public string CatalogFile
        {
            get { return _driverPackage.CatalogFile; }
        }
        ...
        public string ClassDescription
        {
            get { return _driverPackage.ClassDescription; }
        }
        ...
        public string ClassGuid
        {
            get { return _driverPackage.ClassGuid; }
        }
        ...
        public string ClassName
        {
            get { return _driverPackage.ClassName; }
        }
        ...
        {
            get { return _driverPackage.Date; }
        }
        ...
        public DismDriverSignature DriverSignature
        {
            get { return _driverPackage.DriverSignature; }
        }

        /// <summary>
        ///     Gets a value indicating if the driver is included on the Windows distribution media and automatically installed as
        ///     part of Windows®.
        /// </summary>
        public bool InBox
        {
            get { return _driverPackage.InBox; }
        }
        ...
        public string OriginalFileName
        {
            get { return _driverPackage.OriginalFileName; }
        }
        ...
        public string ProviderName
        {
            get { return _driverPackage.ProviderName; }
        }
        ...
        public string PublishedName
        {
            get { return _driverPackage.PublishedName; }
        }
        ...
        /// <summary>
        ///     Determines whether the specified <see cref="DismDriverPackage" /> is equal to the current
        ///     <see cref="DismDriverPackage" />.
        /// </summary>
        /// <param name="driverPackage">The <see cref="DismDriverPackage" /> object to compare with the current object.</param>
        /// <returns>
        ///     true if the specified <see cref="DismDriverPackage" /> is equal to the current
        ///     <see cref="DismDriverPackage" />; otherwise, false.
        /// </returns>
        ...
        public override int GetHashCode()
        {
            return BootCritical.GetHashCode()
                   ^ InBox.GetHashCode()
                   ^ (string.IsNullOrWhiteSpace(CatalogFile) ? 0 : CatalogFile.GetHashCode())
                   ^ (string.IsNullOrWhiteSpace(ClassDescription) ? 0 : ClassDescription.GetHashCode())
                   ^ (string.IsNullOrWhiteSpace(ClassGuid) ? 0 : ClassGuid.GetHashCode())
                   ^ (string.IsNullOrWhiteSpace(ClassName) ? 0 : ClassName.GetHashCode())
                   ^ Date.GetHashCode()
                   ^ DriverSignature.GetHashCode()
                   ^ (string.IsNullOrWhiteSpace(OriginalFileName) ? 0 : OriginalFileName.GetHashCode())
                   ^ (string.IsNullOrWhiteSpace(ProviderName) ? 0 : ProviderName.GetHashCode())
                   ^ (string.IsNullOrWhiteSpace(PublishedName) ? 0 : PublishedName.GetHashCode());
        }
    }
