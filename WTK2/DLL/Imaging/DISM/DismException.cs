...
namespace Microsoft.Dism
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="DismException" /> class with a specified error that is the cause of
        ///     this exception.
        /// </summary>
        ...
        internal static Exception GetDismExceptionForHR(int errorCode)
        {
            ...
            var lastError = DismApi.GetLastErrorMessage();
    ...
    /// <summary>
    ///     The exception that is thrown when an attempt to use the DismApi occurs without first calling
    ///     <see cref="DismApi.Initialize(DismLogLevel)" />.
    /// </summary>
    [Serializable]
