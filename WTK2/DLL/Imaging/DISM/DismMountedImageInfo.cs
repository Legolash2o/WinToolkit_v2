...
namespace Microsoft.Dism
{
    ...
    public sealed class DismMountedImageInfo
    {
        ...
        public string ImageFilePath
        {
            get { return _mountedImageInfo.ImageFilePath; }
        }
        ...
        {
            get { return (int) _mountedImageInfo.ImageIndex; }
        }
        ...
        public DismMountMode MountMode
        {
            get { return _mountedImageInfo.MountMode; }
        }
        ...
        public string MountPath
        {
            get { return _mountedImageInfo.MountPath; }
        }
        ...
        public DismMountStatus MountStatus
        {
            get { return _mountedImageInfo.MountStatus; }
        }
        ...
        /// <summary>
        ///     Determines whether the specified <see cref="DismMountedImageInfo" /> is equal to the current
        ///     <see cref="DismMountedImageInfo" />.
        /// </summary>
        /// <param name="mountedImageInfo">The <see cref="DismMountedImageInfo" /> object to compare with the current object.</param>
        /// <returns>
        ///     true if the specified <see cref="DismMountedImageInfo" /> is equal to the current
        ///     <see cref="DismMountedImageInfo" />; otherwise, false.
        /// </returns>
