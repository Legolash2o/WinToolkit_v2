...
namespace Microsoft.Dism
{
    ...
    {
        /// <summary>
        ///     A client-defined callback function that DISM API uses to report progress on time-consuming operations. API
        ///     functions that report progress accept a pointer to a DismProgressCallback function. DISM_PROGRESS_CALLBACK is a
        ///     typedef to this function type.
        /// </summary>
        /// <param name="current">The current progress value.</param>
        /// <param name="total">The total progress value.</param>
        /// <param name="userData">
        ///     User defined custom data. This parameter can be passed to another DISM function that accepts a
        ///     progress callback and that function will then pass it through to DismProgressCallback.
        /// </param>
        /// <remarks>
