...
namespace Microsoft.Dism
{
    ...
    {
        /// <summary>
        ///     Indicates to the DismCommitImage Function or the DismUnmountImage Function that changes to the image should be
        ///     saved.
        /// </summary>
        public const uint DISM_COMMIT_APPEND = 0x00020000;

        /// <summary>
        ///     Indicates to the DismCommitImage Function or the DismUnmountImage Function to set a flag on the image specifying
        ...
        /// <summary>
        ///     Indicates to the DismUnmountImage Function that all changes should be saved. This flag is equivalent to using
        ///     DISM_COMMIT_IMAGE, DISM_COMMIT_GENERATE_INTEGRITY, and DISM_COMMIT_APPEND.
        /// </summary>
        public const uint DISM_COMMIT_MASK = 0xFFFF0000;

        /// <summary>
        ///     Indicates to the DismCommitImage Function or the DismUnmountImage Function that changes to the image should not be
        ///     saved.
        /// </summary>
        ...
        /// <summary>
        ///     Indicates to the DismMountImage Function that the image should be mounted with optimization. When the optimize
        ///     option is used, only the top level of the file directory in the image will be mapped to the mount location. The
        ///     first time that you access a file path that is not initially mapped, that branch of the directory will be mounted.
        ///     As a result, there may be an increase in the time that is required to access a directory for the first time after
        ///     mounting an image using the optimize option.
        /// </summary>
        ...
        /// <summary>
        ///     Indicates to the DismOpenSession Function that the online operating system, %windir%, should be associated to the
        ///     DISMSession for servicing.
        /// </summary>
