...
namespace Microsoft.Dism
{
    ...
    public enum DismMountImageOptions : uint
    {
        ...
        /// <summary>
        ///     Indicates that the image should be mounted with optimization. When the optimize option is used, only the top level
        ///     of the file directory in the image will be mapped to the mount location. The first time that you access a file path
        ///     that is not initially mapped, that branch of the directory will be mounted. As a result, there may be an increase
        ///     in the time that is required to access a directory for the first time after mounting an image using the optimize
        ///     option.
        /// </summary>
    ...
    public enum DismPackageFeatureState : uint
    {
        ...
        /// <summary>
        ///     An uninstall process for the package or feature is pending. Additional processes are pending and must be completed
        ///     before the package or feature is successfully uninstalled.
        /// </summary>
        UninstallPending,
        ...
        /// <summary>
        ///     The install process for the package or feature is pending. Additional processes are pending and must be completed
        ///     before the package or feature is successfully installed.
        /// </summary>
        InstallPending,
