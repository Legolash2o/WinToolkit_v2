...
namespace Microsoft.Wim
{
    public static partial class WimgApi
    {
        ...
        ///     WIM_GENERIC_WRITE for read/write (append) access.
        /// </summary>
        internal const uint WIM_GENERIC_READ = 0x80000000;

        /// <summary>
        ///     Specifies write access to the image file. Enables images to be captured to the file. Includes WIM_GENERIC_READ
        ...
        /// <summary>
        ///     Opens the image file if it exists. If the file does not exist and the caller requests WIM_GENERIC_WRITE access, the
        ///     function makes the file.
        /// </summary>
