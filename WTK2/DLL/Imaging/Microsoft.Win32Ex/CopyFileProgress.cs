...
namespace Microsoft.Win32
{
    ...
    public sealed class CopyFileProgress
    {
        ...
        public CopyFileProgress(string sourceFilePath, string destinationFilePath,
            CopyFileProgressCallback copyProgressCallback, object userData)
        {
        ...
        /// <summary>
        ///     Gets the total number of bytes transferred from the source file to the destination file since the copy operation
        ///     began.
        /// </summary>
        ...
        /// </returns>
        public CopyFileProgressAction CopyProgressHandler(ulong totalFileSize, ulong totalBytesTransferred,
            ulong streamSize, ulong streamBytesTransferred, uint streamNumber, uint callbackReason, IntPtr sourceFile,
            IntPtr destinationFile, IntPtr data)
        {
            ...
            //
            if (callbackReason == (uint) CopyFileProgressCallbackReason.StreamSwitch)
            {
            ...
            //
            else if (callbackReason == (uint) CopyFileProgressCallbackReason.ChunkFinished)
            {
                // Default the percent complete to 100
                //
                var percentComplete = 1.0m;
                ...
                if (percentComplete != PercentComplete)
                {
                    ...
                    EstimatedTimeRemaining =
                        TimeSpan.FromSeconds((((DateTime.Now - _timeStarted).TotalSeconds/totalBytesTransferred)*
